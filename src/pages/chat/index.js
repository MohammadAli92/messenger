...
export default function Index() {
  ...
  function handleSearchInChatName(receivedKeyword) {
  ...
  return (
    <div className={styles['layout']}>
      <div className={styles['side']}>
        <AppStatus onSearch={handleSearchInChatName} onClearSearch={handleClearSearch} />
        <List>
          {chatList.filter(x => x.name.toLowerCase().includes(keyword.toLowerCase()))
            .map(chat => {
